...
import { fetchMotorNews } from "../services/newsApi";
...
const MotorPage = () => {
  ...
  const loadNews = async () => {
    setLoading(true);
    try {
      const data = await fetchMotorNews();
      setNews(data);
      setFilteredNews(data);
    } catch (error) {
      console.error("Error loading motorcycle news:", error);
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="page-news">
      <section className="page-header">
        <div className="container">
          ...
          <p className="page-subtitle">Update terkini seputar dunia sepeda motor dan industri roda dua</p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="search-wrapper">
            <div className="search-box">
              ...
              <input type="text" placeholder="Cari berita motor..." value={searchQuery} onChange={handleSearchChange} className="search-input" />
            </div>
          ...
          <div className="container">
            {filteredNews.length > 0 ? (
              ...
              <div className="no-results">
                <p>Tidak ada berita motor yang ditemukan.</p>
              </div>
            )}
          </div>
        </section>
